...
public class UIManagerTech : MonoBehaviour {
    ...
    [Tooltip("The UI Panel holding the Delete Save Screen elements")]
    ...
    void Start() {
        ...
        if (deleteSaveScreen != null)
            deleteSaveScreen.SetActive(false);
    ...
    public void ConfirmDeleteSave() {
        ...
        PrintMessage("Deleted save: <SAVE NAME>");
